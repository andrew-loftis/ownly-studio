...
const Notifications = () => {
  ...
  return <div className="topbar-item">
      <Dropdown align={'end'}>
        ...
        <DropdownMenu className="p-0 dropdown-menu-start dropdown-menu-lg" style={{
        minHeight: 300
      }}>
          ...
          <SimplebarReactClient className="position-relative z-2 card shadow-none rounded-0" style={{
          maxHeight: 300
        }}>
            {notifications.map((item, idx) => <div className="notification-item dropdown-item py-2 text-wrap" id="notification-1" key={idx}>
                  <span className="d-flex align-items-center">
                    {item.image ? <span className="me-3 position-relative flex-shrink-0">
                        ...
                        </span> : <div className="avatar-md flex-shrink-0 me-3">
