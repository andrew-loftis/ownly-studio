...
const TotalRevenue = () => {
  const TotalRevenueOpts = {
    series: [{
      name: "Total Income",
      type: "area",
      data: [81.98, 90.55, 63.14, 100.0, 71.22, 77.18, 47.07, 26.24, 85.03, 38.91, 81.3, 33.59]
    }, {
      name: "Total Expenses",
      type: "area",
      data: [30.28, 33.45, 50.0, 31.12, 26.59, 34.06, 39.79, 14.38, 33.44, 48.12, 27.91, 23.91]
    }],
    chart: {
      height: 300,
      type: "line",
